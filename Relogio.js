...
function draw() {
    ...
    fill(255); // Deixar circulo sem preenchimento
    ...
    drawPointer(s, segRadius, 60, 'black');
    drawPointer(m, minRadius, 60, 'black');
    drawPointer(h, horaRadius, 12, 'black');
}
